...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                final String where = ContractCPContactos.FIELD_ID + " = ?";
                                ...
                                Snackbar.make(view,"¿Estás seguro",Snackbar.LENGTH_LONG).setAction("SI",
                                        new View.OnClickListener(){
                                            ...
                                            public void onClick(View view) {
                                                 ...
                                                 */
                                                getContentResolver().delete(ContractCPContactos.CONTENT_URI,where,argumentos);
                                                onActivityResult(1000,-1,getIntent());
                                            }
                                        }).show();
                                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==1000 && resultCode==RESULT_OK){
            ...
            c = getContentResolver().query(Uri.withAppendedPath(ContractCPContactos.CONTENT_URI,""),
                    ContractCPContactos.PROJECTION,null,null,null);
            lv = findViewById(R.id.lv);
